                          ...
                          return Container (
                              ...
                              child: Row(
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          Text(footPlayers[index].number + " " + footPlayers[index].name, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
                                  ...
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          ...
                                          Text(footCoaches[index].title, style: TextStyle(fontSize: 18.0, color: Colors.white), textAlign: TextAlign.center,),
