                                  ...
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          ...
                                          Text(golfPlayers[index].hometown + " / " + golfPlayers[index].highSchool, style: TextStyle(fontSize: 16, color: Colors.white), textAlign: TextAlign.center,),
                                  ...
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          ...
                                          Text(golfCoaches[index].title, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
