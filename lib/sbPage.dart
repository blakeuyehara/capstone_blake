                                  ...
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          ...
                                          Text(sbPlayers[index].hometown + " / " + sbPlayers[index].highSchool, style: TextStyle(fontSize: 16.5, color: Colors.white), textAlign: TextAlign.center,),
                          ...
                          return Container (
                              ...
                              child: Row(
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          Text(sbCoaches[index].name, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
                                          Text(sbCoaches[index].title, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
...
class SBCoaches
{
  SBCoaches({this.name, this.title, this.image});
  final String name;
  final String title;
  final NetworkImage image;
}

List<SBCoaches> sbCoaches = <SBCoaches>[
  SBCoaches(name: "Traci Barrett", title: "Head Coach", image: NetworkImage('https://golutes.com/images/2020/1/21/Barrett.jpg?width=80')),
  SBCoaches(name: "Daryl Ashpole", title: "Assistant Coach", image: NetworkImage('https://golutes.com/images/2020/1/21/Ashpole.jpg?width=80')),
  SBCoaches(name: "Ron Balmer", title: "Assistant Coach", image: NetworkImage('https://golutes.com/images/2020/1/21/Balmer.jpg?width=80')),
  SBCoaches(name: "Tori Hamura", title: "Assistant Coach", image: NetworkImage('https://golutes.com/images/2020/1/21/Hamura.jpg?width=80')),
];
