                          ...
                          return Container (
                              ...
                              child: Row(
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          Text(bskPlayers[index].number + " " + bskPlayers[index].name, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
                                  ...
                                  children: <Widget> [
                                    ...
                                    Center(child: Column(
                                        children: <Widget>[
                                          ...
                                          Text(bskCoaches[index].title, style: TextStyle(fontSize: 26.0, color: Colors.white), textAlign: TextAlign.center,),
